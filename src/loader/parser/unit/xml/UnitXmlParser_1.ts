module egret3d {
    ...
    * @platform Web,Native
    */
    export class UnitXmlParser_1 extends UnitXmlParser {
        ...
        public parseMethod(node: Node): UnitMatMethodData[] {
            if (node.childNodes.length <= 1)
                return null;
        ...
        public parseMat(node: Node): UnitMatSphereData {
        ...
        public parseNode(node: Node): UnitNodeData {
            if (node.childNodes.length == 1)
                return null;
        ...
        public parseHud(node: Node): UnitHUDData {
            if (node.childNodes.length == 1)
                return null;
