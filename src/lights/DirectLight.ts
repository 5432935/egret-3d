module egret3d {
    ...
    */
    export class DirectLight extends LightBase {
        ...
        * @platform Web,Native
        */
        constructor(dir: Vector3D = new Vector3D(0, 0, 1)) {
            super();
            this._dir.copyFrom(dir);
            this._dir.normalize();

            Quaternion.fromToRotation(Vector3D.Z_AXIS, this._dir, DirectLight.q0);
        ...
        */
        ...
        protected onUpdateTransform() {
            ...
            this.globalOrientation.transformVector(Vector3D.Z_AXIS, this._dir);
            this._dir.normalize();
        }
        ...
        */
        public updateLightData(camera: Camera3D, index: number, lightData: Float32Array) {
            ...
            var dir: egret3d.Vector3D = this.dir;
