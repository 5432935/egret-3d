    ...
    */
    export class StaticMergeUtil {
        ...
        private static batching(matID: any, nodes: UnitNodeData[][]): Mesh[] {
            var modelMatrix: Matrix4 = Matrix4.helpMatrix;
            var normalMatrix: Matrix4 = Matrix4.helpMatrix2;
            var mesh: Mesh;
            var vertexLenth: number;
            var pos: Vector3 = Vector3.HELP_0;
            ...
            for (var packIndex: number = 0; packIndex < nodes.length; packIndex++) {
                ...
                for (count = 0; count < meshs.length; count++) {
                    ...
                    normalMatrix.makeTransform(new Vector3(), mesh.globalScale, mesh.globalOrientation);
                    ...
                    for (var g: number = 0; g < mesh.geometry.subGeometrys.length; g++) {
                        ...
                        if (meshs[count].materialIDs[g] == matID) {
                            ...
                            for (var i: number = 0; i < subGeometry.count; ++i) {
                                ...
                                modelMatrix.transformVector(pos, Vector3.HELP_1);
                                normalMatrix.transformVector(normal, Vector3.HELP_2);
                                //quaternion.transformVector(normal, Vector3.HELP_2);

                                vertexs[currentVertexOffset * vertexLenth + 0] = Vector3.HELP_1.x;
                                vertexs[currentVertexOffset * vertexLenth + 1] = Vector3.HELP_1.y;
                                vertexs[currentVertexOffset * vertexLenth + 2] = Vector3.HELP_1.z;

                                vertexs[currentVertexOffset * vertexLenth + 3] = Vector3.HELP_2.x;
                                vertexs[currentVertexOffset * vertexLenth + 4] = Vector3.HELP_2.y;
                                vertexs[currentVertexOffset * vertexLenth + 5] = Vector3.HELP_2.z;
                            ...
                            //    vertexs[vertexOffset + i * vertexLenth + 0] = Vector3.HELP_1.x;
                            //    vertexs[vertexOffset + i * vertexLenth + 1] = Vector3.HELP_1.y;
                            //    vertexs[vertexOffset + i * vertexLenth + 2] = Vector3.HELP_1.z;
