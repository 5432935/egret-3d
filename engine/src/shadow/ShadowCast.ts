    ...
    export class ShadowCast {
        ...
        */
        constructor( view:View3D ) {
            ...
            var v: Vector3 = MathUtil.CALCULATION_VECTOR3D;
        ...
        */
        ...
        private calculateBoundBox(entityCollect: EntityCollect) {
            ...
            this._boundBox.min.copyFrom(new Vector3(MathUtil.MAX_VALUE, MathUtil.MAX_VALUE, MathUtil.MAX_VALUE));
            this._boundBox.max.copyFrom(new Vector3(-MathUtil.MAX_VALUE, -MathUtil.MAX_VALUE, -MathUtil.MAX_VALUE));
