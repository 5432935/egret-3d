module egret3d {
    ...
    */
    export class PanController extends ControllerBase {
        ...
        private _startVec3D: Vector3 = new Vector3();
        private _endVec3D: Vector3 = new Vector3();
        private _currentVec3D: Vector3 = new Vector3();
        private _fixinterpolate: Vector3 = new Vector3();
        private _fix: Vector3 = new Vector3();
        private _final: Vector3 = new Vector3();

        private _rotaAngle: Vector3 = new Vector3();
        private _looat: Vector3 = new Vector3();
        ...
        */
        public update(interpolate: boolean = true): void {
            if (this._useCompass) {
                ...
                this._calQua.transformVector(Vector3.Z_AXIS, this._dir);


                this._calQua.fromEulerAngles(this._rotaAngle.x, this._rotaAngle.y, this._rotaAngle.z);
                this._calQua.transformVector(Vector3.Y_AXIS, this._up);
