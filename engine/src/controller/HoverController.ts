module egret3d {
    ...
    */
    export class HoverController extends ControllerBase {
        ...
        private _lookAtPosition: Vector3 = new Vector3(0.0, 0.0, 0.0);
        ...
        */
        public update(interpolate: boolean = true): void {
            ...
            var pos: Vector3 = (this._lookAtObject) ? this._lookAtObject.position : (this._lookAtPosition) ? this._lookAtPosition : this._origin;
