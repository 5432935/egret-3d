module egret3d {
    ...
    */
    export class LookAtController extends ControllerBase{
        ...
        protected _lookAtPosition: Vector3 = new Vector3();

        private _eyesPos: Vector3 = new Vector3();
        private _up: Vector3 = Vector3.Y_AXIS;

        private _eyesLength: number = 100;
        private _rotaEyesLine: Vector3 = new Vector3(0, 0, 1);
        private _rotaAngle: Vector3 = new Vector3();

        private _matRot: Matrix4 = new Matrix4();
        private _quaRot: Quaternion = new Quaternion();

        private _tempVec: Vector3 = new Vector3();
        private _matTemp: Matrix4 = new Matrix4();
        ...
        * @platform Web,Native
        */
        public lookAtOffset: Vector3 = new Vector3(0, 0, 0);
        ...
        * @platform Web,Native
        */
        public  set lookAtPosition(val: Vector3) {
        ...
        */
        public update(delay: number = 16.6, time:number = 0) {
            ...
            if (this._target) {
                ...
                this._rotaEyesLine.copyFrom(this._quaRot.transformVector(Vector3.Z_AXIS, MathUtil.CALCULATION_VECTOR3D));
                ...
                if (this._keyArray[1]) {
                    ...
                    this._matTemp.createByRotation(90, Vector3.Y_AXIS);
                ...
                if (this._keyArray[4]) {
                    ...
                    this._quaRot.fromEulerAngles(this._rotaAngle.x, this._rotaAngle.y, 0);
                    this._tempVec.copyFrom(this._quaRot.transformVector(Vector3.Y_AXIS, MathUtil.CALCULATION_VECTOR3D));
                    this._tempVec.normalize();
                    this._tempVec.scaleBy(speed);
                    this._tempVec.copyFrom(this._lookAtObject.position.add(this._tempVec, MathUtil.CALCULATION_VECTOR3D));
                    this._lookAtObject.position = this._tempVec;
