module egret3d {
    ...
    */
    export class GrassMethod extends MethodBase {
        ...
        private _windDirection: Vector3 = new Vector3(1, 0, 0);
        private _windSpace: Vector3 = new Vector3(400, 0, 300);
        ...
        * @platform Web,Native 
        */
        public setWind(direction: Vector3, space: Vector3, speed: number = 100.0, windStrength: number = 0.1, shakeScale:number = 1.0): void {
            direction.y = 0;
        ...
        * @platform Web,Native 
        */
        public updateSqueezeData(position: Vector3, enable:boolean, radius: number = 20, strength:number = 1.0): void {
