module egret3d {
   ...
   */
    export class GrassMesh extends Mesh {
        ...
        * @platform Web,Native 
        */
        constructor(birthPoints:Vector3[], material: MaterialBase, data:GrassData) {
            super(null, material);
            ...
            this._plantShape = new PlaneGeometry(1, 1, 1, 1, 1, 1, Vector3.Z_AXIS, true, false);
            this.initialize();
            this.initBoudBox(new Vector3(MathUtil.MAX_VALUE, MathUtil.MAX_VALUE, MathUtil.MAX_VALUE));
        }
        ...
        * @platform Web,Native
        */
        private initBoudBox(vector: Vector3) {
            //##FilterBegin## ##Particle##
            var b: BoundBox = new BoundBox(this);
            b.fillBox(new Vector3(-vector.x / 2, -vector.y / 2, -vector.z / 2), new Vector3(vector.x / 2, vector.y / 2, vector.z / 2));
            this.bound = b;
            this.initAABB();
            //##FilterEnd##
        }
        ...
        */
        private initPostionData(geometry: Geometry, count: number) {
            var positionArray: Vector3[] = this._birthPoints;
            ...
            for (var i: number = 0; i < count; ++i) {
                var pos: Vector3 = positionArray[i];
