module egret3d {
    ...
    */
    export class ParticleDataProperty extends ParticleDataNode {
        ...
        * @platform Web,Native
        */
        public bounds: Vector3 = new Vector3(10, 10, 10);
        /**
        * @language zh_CN
        ...
        * @platform Web,Native
        */
        public rotation: Vector3 = new Vector3(0, 0, 0, 1);
        /**
        * @language zh_CN
        * 缩放信息，粒子模型的缩放数据
        * @version Egret 3.0
        * @platform Web,Native
        */
        public scale: Vector3 = new Vector3(1, 1, 1, 1);
        /**
        * @language zh_CN
        * 位置信息，粒子模型的位置数据
        * @version Egret 3.0
        * @platform Web,Native
        */
        public position: Vector3 = new Vector3(0, 0, 0, 1);
        /**
        * @language zh_CN
        ...
        */
        public validate(): void {
            if (this.bounds == null) {
                this.bounds = new Vector3(10, 10, 10);
            }
            if (this.bounds.x < 0) {
                this.bounds.x = 1;
            }
            ...
            if (this.rotation == null) {
                this.rotation = new Vector3(0, 0, 0, 1);
            }
            if (this.scale == null) {
    ...
    */
    export class ParticleDataShape extends ParticleDataNode {
        ...
        * @platform Web,Native
        */
        public externalPositionList: Vector3[];
