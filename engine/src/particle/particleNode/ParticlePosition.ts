    ...
    export class ParticlePosition extends AnimationNode {
        ...
        */
        public build(geometry: Geometry, count: number) {
            ...
            var positionArray: Vector3 = this._positions.calculate(count);
            var directionArray: Vector3[] = this._animationState.directionArray = [];
            var meshNormalArray: Vector3[];
            ...
            var recordPos: Vector3 = new Vector3();//用于计算方向，缩放后的位置不能用于计算方向
