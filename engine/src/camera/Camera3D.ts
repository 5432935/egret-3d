    ...
    */
    export class Camera3D extends Object3D {
        ...
        */
        ...
        private _lookAtPosition: Vector3 = new Vector3();
        ...
        private _normalMatrix: Matrix4 = new Matrix4();
        ...
        protected _mat: Matrix4 = new Matrix4();

        protected _maxBest: boolean = false;
        protected _maxBestPoint: Point = new Point() ;


        private _angleVector: Vector3 = new Vector3();
        /*
        * @private
        */
        public billboardX: Matrix4 = new Matrix4();
        /*
        * @private
        */
        public billboardY: Matrix4 = new Matrix4();
        /*
        * @private
        */
        public billboardZ: Matrix4 = new Matrix4();
        /*
        * @private
        */
        public billboardXYZ: Matrix4 = new Matrix4();
        ...
        */
        public lookAt(pos: Vector3, target: Vector3, up: Vector3 = Vector3.Y_AXIS) {
            ...
            var prs: Vector3[] = this._mat.decompose(Orientation3D.QUATERNION);
        ...
        */
        ...
        protected onMakeTransform() {
            Vector3.HELP_1.setTo(1, 1, 1, 1);
            Vector3.HELP_0.setTo(0, 0, 0, 1);

            this._modelMatrix3D.makeTransform(this._pos, Vector3.HELP_1, this._orientation);
            this._modelMatrix3D.makeTransform(this._globalPos, Vector3.HELP_1, this._globalOrientation);
            ...
            this.billboardY.createByRotation(this._angleVector.y, Vector3.Y_AXIS);

            //this.billboardZ.identity();
            //this.billboardZ.appendRotation(this._angleVector.z, Vector3.Z_AXIS);

            this.billboardXYZ.makeTransform(Vector3.HELP_0, Vector3.HELP_1, this._globalOrientation);
        }
        ...
        * @platform Web,Native
        */
        public updataOrth(target: Matrix4) {
        ...
        */
        ...
        private unproject(nX: number, nY: number, sZ: number, target: Vector3): Vector3 {
            target.x = nX;
            target.y = -nY;
            target.z = sZ;
            target.w = 1.0;
