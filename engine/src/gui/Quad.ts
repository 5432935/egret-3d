module egret3d {
    ...
    */
    export class Quad extends DisplayObject {
        ...
        private static IdentityVector: Vector3 = new Vector3(1, 1, 1, 1);
        private static TempVector: Vector3 = new Vector3();
        ...
        */
        public updateVertices(zIndex: number, geometry: Geometry, globalIndex: number) {
            ...
            var rot: Vector3 = this.globalRotation;
            ...
            if (this._colorInvalid) {
                ...
                var tempVector: Vector3 = Quad.TempVector;
