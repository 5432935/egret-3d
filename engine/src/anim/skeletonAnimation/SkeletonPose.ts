    ...
    */
    export class SkeletonPose {
        ...
        */
        ...
        private static _temp_jointMatrix: Matrix4 = new Matrix4();
        private static _temp_matrixDecomposeA: Vector3[] = [new Vector3(), new Vector3(), new Vector3()];
        ...
        */
        ...
        private calculateAbsoluteMatrix(joint: Joint ,joints:Joint[] ): void {
            ...
            if (!joint.worldMatrixValid) {
                if (!joint.worldMatrix) joint.worldMatrix = new Matrix4();

                joint.localMatrix = joint.localMatrix || new Matrix4();
        ...
        * @platform Web,Native
        */
        public updateGPUData(skeleton: Skeleton, skeletonMatrixData: Float32Array, offset: Vector3): Float32Array {
            ...
            for (var i: number = 0; i < skeletonTotalJoint; ++i) {
                ...
                for (var j: number = 0; j < jointLen; ++j) {
                    ...
                    Matrix4.helpMatrix.copyFrom(skeletonJoints[i].inverseMatrix);

                    Matrix4.helpMatrix.append(joints[j].worldMatrix);

                    var test: Vector3[] = Matrix4.helpMatrix.decompose(Orientation3D.QUATERNION);
        ...
        */
        public initSkeletonPose(a: SkeletonPose, target: SkeletonPose) {
            ...
            for (var i: number = 0; i < a.joints.length; i++) {
                ...
                joint.worldMatrix = joint.worldMatrix || new Matrix4();
            }
        }
    }
}