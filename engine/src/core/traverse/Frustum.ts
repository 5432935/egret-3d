module egret3d {
    ...
    */
    export class Frustum {
        ...
        private _vertex: Array<Vector3>;
        private _tempVertices: Array<Vector3>;
        ...
        private nearCenter: Vector3 = new Vector3();
        private farCenter: Vector3 = new Vector3();
        ...
        */
        constructor(camera: Camera3D = null) {
            this.camera = camera;
            this._vertex = new Array<Vector3>();
            for (var i: number = 0; i < this._vtxNum; ++i) {
                this._vertex.push(new Vector3());
            }

            this._tempVertices = new Array<Vector3>();
            for (var i: number = 0; i < this._vtxNum; ++i) {
                this._tempVertices.push(new Vector3());
            }
            ...
            this.box = new BoundBox(null, new Vector3(), new Vector3());
        ...
        */
        public update() {
            ...
            /// 摄像机变化之后的顶点也变化;
            var mat: Matrix4 = Matrix4.helpMatrix;
        ...
        * @platform Web,Native
        */
        public inSphere(center: Vector3, radius: number): boolean {
            var dis: number = 0;
            for (var i: number = 0; i < this._plane.length; ++i) {
