    ...
    */
    export class Mesh extends IRender implements IQuadNode{
        ...
        */
        ...
        private static AABB_TL_1: Vector3 = new Vector3();
        private static AABB_TR_1: Vector3 = new Vector3();
        private static AABB_BL_1: Vector3 = new Vector3();
        private static AABB_BR_1: Vector3 = new Vector3();
        private static AABB_TL_2: Vector3 = new Vector3();
        private static AABB_TR_2: Vector3 = new Vector3();
        private static AABB_BL_2: Vector3 = new Vector3();
        private static AABB_BR_2: Vector3 = new Vector3();
        /**
        * @private
        * 更新绑定盒的全局数据，适用于静态物体
        */
        public calcGlobalQuadAABB(): void {
            ...
            var mtx: Matrix4 = this.modelMatrix;
        ...
        */
        protected buildBoundBox(): Bound {
            ...
            if (this.geometry && this.geometry.vertexArray) {
                bound.min.copyFrom(new Vector3(MathUtil.MAX_VALUE, MathUtil.MAX_VALUE, MathUtil.MAX_VALUE));
                bound.max.copyFrom(new Vector3(-MathUtil.MAX_VALUE, -MathUtil.MAX_VALUE, -MathUtil.MAX_VALUE));
