module egret3d {
    ...
    export class TerrainCollision{
        ...
        private _offsetPos: Vector3;
        constructor(mesh:Mesh) {
            this.mesh = mesh; 
            this._offsetPos = new Vector3();
        ...
        private buildFace() {
           ...
           for (var i: number = 0; i < this._geometry.indexCount / 3; i++) {
               ...
               face.v_0 = new Vector3();
               face.v_1 = new Vector3();
               face.v_2 = new Vector3();
               face.min = new Vector3();
               face.max = new Vector3();
               face.centre = new Vector3();
        ...
        public checkPointInTriangle(x: number, y: number, face :Face): boolean {
            var p1: Vector3 = face.v_0;
            var p2: Vector3 = face.v_1;
            var p3: Vector3 = face.v_2;
        ...
        private getHeightInTriangle(x: number, y: number, face: Face): number {
            ...
            var tmp: Vector3 = Vector3.HELP_2 ;
            ...
            var p4: Vector3 = Vector3.HELP_0;		// p4 in p1 p3
            var p5: Vector3 = Vector3.HELP_1;		// p4 in p2 p3
