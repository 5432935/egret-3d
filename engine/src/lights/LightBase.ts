module egret3d {
    ...
    */
    export class LightBase extends Object3D {
        ...
        * 环境颜色
        */
        protected _ambient: Vector3 = new Vector3(0.0, 0.0, 0.0);
        ...
        * 漫反射  
        */
        protected _diffuse: Vector3 = new Vector3(1.0, 1.0, 1.0);
         ...
         * 镜面反射  
         */
        protected _specular: Vector3 = new Vector3(1.0, 1.0, 1.0);
        /**
         * @language zh_CN  
         *@private
         */
        protected _halfVector: Vector3 = new Vector3(1.0, 1.0, 1.0 );
         ...
         *@private
         */
        protected lightViewPos: Vector3 = new Vector3();
