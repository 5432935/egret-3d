module egret3d {
    ...
    */
    export class MathUtil {
        ...
        * @private
        */
        public static CALCULATION_MATRIX: Matrix4 = new Matrix4();
        ...
        * @private
        */
        public static CALCULATION_VECTOR3D: Vector3 = new Vector3();

        /**
        * @private
        */
        public static CALCULATION_VECTOR3D_0: Vector3 = new Vector3();

        /**
        * @private
        */
        public static CALCULATION_VECTOR3D_1: Vector3 = new Vector3();

        /**
        * @private
        */
        public static CALCULATION_VECTOR3D_2: Vector3 = new Vector3();
        ...
        * @platform Web,Native
        */
        public static quaternion2matrix(quarternion: Quaternion, m: Matrix4 = null): Matrix4 {
            ...
            if (m) {
                ...
                return new Matrix4(new Float32Array(raw));
        }
        ...
        * @platform Web,Native
        */
        public static getForward(m: Matrix4, v: Vector3 = null): Vector3 {
            if (v === null) {
        ...
        * @platform Web,Native
        */
        public static getUp(m: Matrix4, v: Vector3 = null): Vector3 {
            //v ||= new Vector3(0.0, 0.0, 0.0);
        ...
        * @platform Web,Native
        */
        public static getRight(m: Matrix4, v: Vector3 = null): Vector3 {
            //v ||= new Vector3(0.0, 0.0, 0.0);
            if (v === null) {
        ...
        * @platform Web,Native
        */
        public static compare(m1: Matrix4, m2: Matrix4): boolean {
        ...
        * @platform Web,Native
        */
        public static reflection(plane: Plane3D, target: Matrix4 = null): Matrix4 {
            if (target === null)
                target = new Matrix4();
        ...
        * @platform Web,Native
        */
        public static getTranslation(transform: Matrix4, result: Vector3 = null): Vector3 {
            if (!result)
                result = new Vector3();
        ...
        * @private
        */
        public static calcDegree(quat: Quaternion, angleVector: Vector3): void {

            //计算billboard矩阵x
            quat.transformVector(Vector3.Y_AXIS, this._tempVector);
            this._tempVector.x = 0;
            this._tempVector.normalize();
            var dotX: number = Vector3.Y_AXIS.dotProduct(this._tempVector);
            ...
            //计算billboard矩阵y
            quat.transformVector(Vector3.Z_AXIS, this._tempVector);
            this._tempVector.y = 0;
            this._tempVector.normalize();
            var dotY: number = Vector3.Z_AXIS.dotProduct(this._tempVector);
            ...
            //计算billboard矩阵z
            quat.transformVector(Vector3.X_AXIS, this._tempVector);
            this._tempVector.z = 0;
            this._tempVector.normalize();
            var dotZ: number = Vector3.X_AXIS.dotProduct(this._tempVector);
