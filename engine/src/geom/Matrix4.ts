module egret3d {
    ...
    */
    export class Matrix4 {
        ...
        * @private
        */
        public static helpMatrix: Matrix4 = new Matrix4();
        public static helpMatrix2: Matrix4 = new Matrix4();
        ...
        */
        public multiply(mat4: Matrix4): void {
            let a = this.rawData, b = mat4.rawData, r = Matrix4.helpMatrix;
        ...
        * @language zh_CN
        */
        public frustum(l: number, r: number, b: number, t: number, n: number, f: number): Matrix4 {
            let m = this.rawData;
        ...
        * @platform Web,Native
        */
        public fromToRotation(fromDirection: Vector3, toDirection: Vector3) {
            let data = this.rawData; 
        ...
        * @platform Web,Native
        */
        public static fromToRotation(fromDirection: Vector3, toDirection: Vector3, target: Matrix4 = null): Matrix4 {
            if (!target) {
                target = new Matrix4();
            }
        ...
        */
        ...
        private static position_000: Vector3 = new Vector3();
        private static scale_111: Vector3 = new Vector3(1, 1, 1);
        /**
        * @language zh_CN
        * 创建一个欧拉旋转矩阵.
        * @param x 绕x轴旋转角度.
        ...
        */
        public rotation(x: number, y: number, z: number) {
            ...
            this.makeTransform(Matrix4.position_000, Matrix4.scale_111, MathUtil.CALCULATION_QUATERNION);
        }
       ...
       */
        public appendRotation(degrees: number, axis: Vector3): void {
            var m: Matrix4 = Matrix4.getAxisRotation(axis.x, axis.y, axis.z, degrees);
            this.append(m);
        }
        ...
        */
        public createByRotation(degrees: number, axis: Vector3): void {
            var tmp: Matrix4 = MathUtil.CALCULATION_MATRIX;
        ...
        * @platform Web,Native
        */
        public copyRowFrom(row: number, vector3D: Vector3) {
            var data = this.rawData;
            switch (row) {
                case 0:
                    data[0] = vector3D.x;
        ...
        * @platform Web,Native
        */
        public copyRowTo(row: number, vector3D: Vector3) {
            var data = this.rawData;
            switch (row) {
                case 0:
                    vector3D.x = data[0];
        ...
        * @platform Web,Native
        */
        public copyColFrom(col: number, vector3D: Vector3) {
            let data: Float32Array = this.rawData;
            switch (col) {
                case 0:
                    data[0] = vector3D.x;
        ...
        * @platform Web,Native
        */
        public copyColTo(col: number, vector3D: Vector3) {
            let data: Float32Array = this.rawData;
            switch (col) {
                case 0:
                    vector3D.x = data[0];
        ...
        */
        ...
        private static prs: Vector3[] = [new Vector3(), new Vector3(), new Vector3()];
        ...
        * @platform Web,Native
        */
        public decompose(orientationStyle: string = "eulerAngles", target: Vector3[] = null): Vector3[] {
            var q: Quaternion = MathUtil.CALCULATION_QUATERNION;
            var vec: Vector3[] = target ? target : Matrix4.prs;
            this.copyRawDataTo(Matrix4.helpMatrix.rawData);
            var mr = Matrix4.helpMatrix.rawData;

            var pos: Vector3 = vec[0];
            pos.x = mr[12];
            pos.y = mr[13];
            pos.z = mr[14];
            mr[12] = 0;
        ...
        * @platform Web,Native
        */
        public deltaTransformVector(v: Vector3, target: Vector3 = null): Vector3 {
            if (!target) {
                target = new Vector3();
            }
            let data: Float32Array = this.rawData;
        ...
        * private
        */
        public static transpose(matrix: Matrix4, result: Matrix4) {
        ...
        * private
        */
        public static inverse(matrix: Matrix4, result: Matrix4) {
            result = result || new Matrix4();
            var m = matrix.rawData, r = result.rawData;
        ...
        * @platform Web,Native
        */
        public makeTransform(pos: Vector3, scale: Vector3, rot: Quaternion) {
            //let data: Float32Array = this.rawData;
            //data[0] = scale.x;
            //data[5] = scale.y;
            //data[10] = scale.z;
        ...
        * @platform Web,Native
        */
        public recompose(components: Vector3[]): boolean {
        ...
        * @platform Web,Native
        */
        public transformVector(v: Vector3, target: Vector3 = null): Vector3 {
            let data: Float32Array = this.rawData;
        ...
        * @platform Web,Native
        */
        public transformVector4(v: Vector3, target: Vector3 = null): Vector3 {
            let data: Float32Array = this.rawData ;
        ...
        * @platform Web,Native
        */
        public mat3TransformVector(v: Vector3, target: Vector3 = null): Vector3 {
            let data: Float32Array = this.rawData ;
        ...
        */
        public transformPlane(plane: Plane3D): Plane3D {
            ...
            mat.invert();
            mat.transpose();
            let v: Vector3 = new Vector3(plane.a, plane.b, plane.c, plane.d);
        ...
        */
        public transpose() {
            ...
            for (var i: number = 0; i < Matrix4.helpMatrix.rawData.length; i++) {
        ...
        */
        public get position(): Vector3 {
            let data: Float32Array = this.rawData;
            return new Vector3(data[12], data[13], data[14]);
        }
