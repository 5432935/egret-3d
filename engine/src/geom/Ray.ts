module egret3d {
    ...
    */
    export class Ray {
        protected static v0: Vector3 = new Vector3();
        protected static v1: Vector3 = new Vector3();
        protected static v2: Vector3 = new Vector3();
        protected static v3: Vector3 = new Vector3();
        protected static v4: Vector3 = new Vector3();
        ...
        * @platform Web,Native
        */
        public IntersectTriangle(v0: Vector3, v1: Vector3, v2: Vector3, ret: Array<number> = null): boolean {
            var edge1: Vector3 = v1.subtract(v0, Ray.v0);
            var edge2: Vector3 = v2.subtract(v0, Ray.v1);

            var pvec: Vector3 = this.dir.crossProduct(edge2, Ray.v2);
            ...
            var qvec: Vector3 = tvec.crossProduct(edge1, Ray.v4);
        ...
        * @private
        */
        protected static transformCenter: Vector3 = new Vector3();
        /**
        * @language zh_CN
        * 计算射线是否和球相交
        * @param center 球中心点
        ...
        * @platform Web,Native
        */
        public IntersectSphere(center: Vector3, radius: number, ret: number[] = null, transform: Matrix4 = null): number[]{

            ret = ret || [];
            Ray.transformCenter.copyFrom(center);

            Ray.v0.copyFrom(Vector3.X_AXIS);
            ...
            var t0: number = 0.0;
            var t1: number = 0.0;
            var oc: Vector3 = Ray.transformCenter.subtract(this.origin, MathUtil.CALCULATION_VECTOR3D_0);
        ...
        */
        ...
        protected static modletriangle: Vector3[] = [new Vector3(), new Vector3(), new Vector3()];
        protected static uvarray: Vector3[] = [new Vector3(), new Vector3(), new Vector3()];
        protected static triangle: Vector3[] = [new Vector3(), new Vector3(), new Vector3()];
        protected static ret: number[] = [0, 0, 0];
        protected static pos: Vector3 = new Vector3();
        ...
        * @platform Web,Native
        */
        public IntersectMesh(verticesData: Float32Array, indexData: Uint16Array, offset: number, faces: number, uv_offset: number, mMat: Matrix4, result: PickResult): boolean {

            var modletriangle: Vector3[] = Ray.modletriangle;
            var uvarray: Vector3[] = Ray.uvarray;
            var triangle: Vector3[] = Ray.triangle;
            ...
            if (face < faces && face >= 0) {
                ...
                var tmp0: Vector3 = v1.subtract(v0, Ray.v0);
                tmp0.scaleBy(u);
                var tmp1: Vector3 = v2.subtract(v0, Ray.v1);
                tmp1.scaleBy(v);
        ...
        private invViewMat: Matrix4 = new Matrix4();
        ...
        * @platform Web,Native
        */
        public CalculateAndTransformRay(width: number, height: number, modelMtx: Matrix4, projMtx: Matrix4, x: number, y: number) {
            this.reset();
