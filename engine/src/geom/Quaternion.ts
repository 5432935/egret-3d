module egret3d {
    ...
    */
    export class Quaternion {
        ...
        * @returns  Matrix4 返回转换后的矩阵
        * @see egret3d.Matrix4
        * @version Egret 3.0
        * @platform Web,Native
        */
        public toMatrix3D(target: Matrix4 = null): Matrix4 {
            let x: number = this.x;
            let y: number = this.y;
            let z: number = this.z;
            let w: number = this.w ;
            ...
            if (!target)
                return new Matrix4(new Float32Array(rawData));
        ...
        * @platform Web,Native
        */
        public fromMatrix(matrix: Matrix4) {
        ...
        * @returns A Vector3 object containing the rotated point.
        */
        /**
        * @language zh_CN
        * 旋转一个3量坐标点
