module egret3d {
    ...
    */
    export class Vector3 {
        ...
        * @platform Web,Native
        */
        public static X_AXIS: Vector3 = new Vector3(1, 0, 0);
        ...
        * @platform Web,Native
        */
        public static Y_AXIS: Vector3 = new Vector3(0, 1, 0);
        ...
        * @platform Web,Native
        */
        public static Z_AXIS: Vector3 = new Vector3(0, 0, 1);
        ...
        * @platform Web,Native
        */
        public copyFrom(src: Vector3): void {
            var v = this;
            v.x = src.x;
            v.y = src.y;
            v.z = src.z;
        ...
        */
        ...
        private Dot(v0: Vector3, v1:Vector3):number {
            return v0.x * v1.x + v0.y * v1.y + v0.z * v1.z;
        }
        private OrthoNormalVectorFast(n: Vector3, target:Vector3):Vector3
        {
            if (!target) {
                target = new Vector3();
            }
        ...
        */
        public slerp(lhs: Vector3, rhs: Vector3, t: number): void {
            ...
            else if (dot < -1.0 + 0.00001)
            {
                ...
                Quaternion.HELP_0.fromAxisAngle(Vector3.HELP_1, 3.1415926 * t * MathUtil.RADIANS_TO_DEGREES);
        ...
        private Cross(lhs: Vector3, rhs: Vector3, target:Vector3 = null): Vector3 {
            if (!target) {
                target = new Vector3();
            }
        ...
        */
         ...
         * @platform Web,Native
         */
        public equal(other: Vector3): boolean {
