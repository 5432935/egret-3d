module egret3d {
    ...
    export class Channel3d extends Channel {
        ...
        * @platform Web,Native
        */
        public set listener(value: Vector3) {
        ...
        */
        ...
        // taken from OpenAL
        private fallOff(posOne: Vector3, posTwo: Vector3, refDistance: number, maxDistance: number, rolloffFactor: number):number {


            var distance: number = Vector3.distance(posOne, posTwo);
