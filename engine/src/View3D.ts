module egret3d {
    ...
    export class View3D {
        ...
        protected _backColor: Vector3 = new Vector3(0.3, 0.3, 0.6, 1.0);
        ...
        public sunLight: DirectLight = new DirectLight(new Vector3(0, -1, 1));
        ...
        */
        public update(time: number, delay: number) {
            ...
            Stage3D.context3DProxy.viewPort(this._viewPort.x, this._viewPort.y, this._viewPort.width, this._viewPort.height);
            Stage3D.context3DProxy.setScissorRectangle(this._viewPort.x, this._viewPort.y, this._viewPort.width, this._viewPort.height);
            ...
            if (this._cleanParmerts & Context3DProxy.gl.COLOR_BUFFER_BIT) {
                Stage3D.context3DProxy.clearColor(this._backColor.x, this._backColor.y, this._backColor.z, this._backColor.w);
            }

            Stage3D.context3DProxy.clear(this._cleanParmerts);

            if (this._backImg) {
                this._backImg.draw(Stage3D.context3DProxy);
            }
            ...
            this._renderQuen.draw(time, delay, Stage3D.context3DProxy, this._entityCollect, this._viewPort);
            ...
            if (this._postList.length > 0) {
                ...
                this._postProcessing.draw(time, delay, Stage3D.context3DProxy, this._entityCollect, this.camera3D, this._viewPort);
            ...
            // hud
            for (var i: number = 0; i < this._huds.length; ++i) {
                this._huds[i].draw(Stage3D.context3DProxy);
            }
            ...
            if (this._quadStage) {
                ...
                this._quadStage.update(time, delay, Stage3D.context3DProxy, this);
