module egret3d {
    ...
    */
    export class WaterWaveMethod extends MethodBase {
        ...
        private _wave_xyz_intensity_0: Vector3 = new Vector3(120.0, 50.0, 70.0);
        private _wave_xyz_intensity_1: Vector3 = new Vector3(80.0, 40.0, 80.0);
        private _wave_xyz_speed_0: Vector3 = new Vector3(0.001, 0.001, -0.001);
        private _wave_xyz_speed_1: Vector3 = new Vector3(0.001, 0.001, 0.001);
