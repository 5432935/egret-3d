    ...
    export class Geometry extends Reference {
        ...
        */
        public cloneMirror(x: boolean, y: boolean, z: boolean): Geometry {
            ...
            var scal: Vector3 = new Vector3(x ? -1 : 1, y ? -1 : 1, z ? -1 : 1);
            ...
            Matrix4.helpMatrix.makeTransform(pos, scal, rot);
            ...
            for (i = 0; i < this.vertexCount; i++){
                ...
                Matrix4.helpMatrix.transformVector(tempPos, Vector3.HELP_0);

                geometry.vertexArray[i * this.vertexAttLength] = Vector3.HELP_0.x;
                geometry.vertexArray[i * this.vertexAttLength + 1] = Vector3.HELP_0.y;
                geometry.vertexArray[i * this.vertexAttLength + 2] = Vector3.HELP_0.z;
            }
