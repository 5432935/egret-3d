module egret3d {
    ...
    export class PlaneGeometry extends Geometry {
        ...
        */
        constructor(width: number = 500, height: number = 500, segmentsW: number = 1, segmentsH: number = 1, uScale: number = 1, vScale: number = 1, aixs: Vector3 = Vector3.Y_AXIS,
        ...
        private buildGeometry(aixs: Vector3): void {
