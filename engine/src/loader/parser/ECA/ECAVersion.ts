module egret3d {
    ...
    export class ECAVersion {
        ...
        public static parserVersion_1(bytes: ByteArray): CameraAnimationController {
            ...
            var scaling: Vector3 = new Vector3(1, 1, 1, 1);
            ...
            while (nFrame--) {
                ...
                cameraAnimationFrame.rotation = new Vector3(
                    bytes.readFloat() * MathUtil.RADIANS_TO_DEGREES + 90,
                    bytes.readFloat() * MathUtil.RADIANS_TO_DEGREES,
                    bytes.readFloat() * MathUtil.RADIANS_TO_DEGREES);

                cameraAnimationFrame.translation = new Vector3(
                    bytes.readFloat(),
                    bytes.readFloat(),
                    bytes.readFloat());

                cameraAnimationFrame.matrix = new Matrix4();
