module egret3d {
    ...
    export class Class_Globe extends Class_View3D {
        ...
        private initScene() {
            ...
            var diffuseTexture: ITexture = this._queueLoad.getAsset("resource/scene/globe/land_ocean_ice_2048_match.jpg");
            var normalTexture: ITexture = this._queueLoad.getAsset("resource/scene/globe/EarthNormal.png");
            var specularTexture: ITexture = this._queueLoad.getAsset("resource/scene/globe/earth_specular_2048.jpg");  
            var lightsTexture: ITexture = this._queueLoad.getAsset("resource/scene/globe/land_lights_16384.jpg");  
            var cloudTexture: ITexture = this._queueLoad.getAsset("resource/scene/globe/cloud_combined_2048.jpg");  
